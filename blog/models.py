...
class Category(models.Model):
    title = models.CharField(max_length=200, unique=True, null=True, blank=True)  # Varchar(200)
...
class Article(models.Model):
    title = models.CharField(max_length=200, unique=True, null=True, blank=True, verbose_name='Sarlavha')
...
class Customer(AbstractUser):
    phone = models.CharField(max_length=15, unique=True, blank=True, verbose_name='Telefon nomer')
    ...
    REQUIRED_FIELDS = ['phone', 'address', 'website', 'github', 'twitter', 'instagram', 'facebook']
